...
QString styleSheet()
{
    return QStringLiteral(
        ...
        "QGraphicsView#LadderCanvas { background-color: #f4f6f9; border-top: 1px solid #b0b0b0; border-bottom: 1px solid #b0b0b0; }"
        "QWidget#LadderEditor { background-color: #d4d4d4; }"
        "QWidget#LadderInstructionBar { background-color: #f3f3f3; border-bottom: 1px solid #b0b0b0; }"
        "QLabel#LadderBarTitle { color: #2d325a; font-size: 11px; font-weight: 700; background: transparent; }"
        "QLabel#LadderBarSubtitle { color: #5a6290; font-size: 10px; background: transparent; }"
        "QPushButton#LadderBarButton, QToolButton#LadderBarButton { background-color: #ffffff; color: #1a1a1a; "
        "border: 1px solid #b0b0b0; border-radius: 2px; padding: 4px 10px; min-height: 26px; font-size: 11px; "
        "font-family: 'Consolas', 'Segoe UI', sans-serif; }"
        "QPushButton#LadderBarButton:hover, QToolButton#LadderBarButton:hover { background-color: #e8f0f8; "
        "border-color: #0078d7; }"
        "QPushButton#LadderBarButton:pressed, QToolButton#LadderBarButton:pressed { background-color: #0078d7; color: #ffffff; }"
        "QDialog#LadderVariableBrowserDialog { background-color: #ffffff; }"
        "QDialog#LadderVariableBrowserDialog QDialogButtonBox { background-color: #f3f3f3; border-top: 1px solid #b0b0b0; padding: 6px; }"
        "QWidget#LadderVariableTable { background-color: #ffffff; }"
        "QWidget#LadderVariableHeader { background-color: #2d325a; }"
        "QWidget#LadderVariableHeader QLabel#LadderBarTitle { color: #ffffff; }"
        "QWidget#LadderVariableHeader QLabel#LadderBarSubtitle { color: #c8cce0; }"
        "QWidget#LadderVariableHeader QPushButton#LadderBarButton { background-color: #3d4570; color: #ffffff; "
        "border-color: #5a6290; min-height: 24px; }"
        "QWidget#LadderVariableHeader QPushButton#LadderBarButton:hover { background-color: #4a5488; }"
        "QTableWidget#LadderVariableGrid { background-color: #ffffff; border: none; gridline-color: #d8d8d8; }"
        "QWidget#LadderPropertiesPanel { background-color: #e1e1e1; border-left: 1px solid #a0a0a0; }"
        "QComboBox#LadderPropertyCombo { min-height: 24px; }"
        ...
        "QSplitter#LadderEditorSplitter::handle:vertical { background-color: #2d325a; height: 5px; }"
        "QSplitter#LadderEditorSplitter::handle:vertical:hover { background-color: #0078d7; }"
        ...
        "QWidget#LadderToolboxGroup { background-color: #ffffff; border: 1px solid #c8c8c8; border-radius: 3px; "
        "padding: 2px; }"
        "QLabel#LadderToolboxGroupTitle { color: #2d325a; font-size: 11px; font-weight: 700; padding: 4px 6px 2px 6px; "
        "background: transparent; }"
        "QToolButton#LadderToolboxItem { background-color: #ffffff; color: #1a1a1a; border: 1px solid transparent; "
        "border-radius: 2px; padding: 2px 6px; font-size: 11px; font-weight: 600; text-align: left; }"
        "QToolButton#LadderToolboxItem:hover { background-color: #e8f0f8; border-color: #0078d7; }"
        "QToolButton#LadderToolboxItem:pressed { background-color: #cce4f7; border-color: #0078d7; }"
        "QScrollArea#LadderToolboxScroll { background-color: transparent; border: none; }"
